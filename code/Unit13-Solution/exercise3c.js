...
// AND the document also contains the term Budapest.
...
//polygon AND text search
function polygonAndText(shape, text) {
...
polygonAndText(hungary, "Budapest").then(function(response) {
  response.forEach(function(document) {
    console.log(
      document.uri + " matches your geo & text search (" +
